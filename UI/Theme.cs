...
namespace Vape.UI
{
    ...
    {
        public static Color VisualPink = new Color(1.00f, 0.28f, 0.62f, 1f);
        ...
        public static Color EnemyVisible = new Color(1.00f, 0.28f, 0.62f, 1f);
        public static Color EnemyHidden = new Color(1.00f, 0.40f, 0.70f, 1f);
        public static Color EnemyAim = new Color(1.00f, 0.56f, 0.78f, 1f);
        ...
        public static Color ItemEsp = new Color(1.00f, 0.42f, 0.70f, 1f);
        public static Color MoveEsp = new Color(1.00f, 0.28f, 0.62f, 1f);
        public static Color BuffEsp = new Color(1.00f, 0.48f, 0.74f, 1f);
        public static Color RadarRing = new Color(1.00f, 0.28f, 0.62f, 0.75f);
        public static Color RadarFill = new Color(0.05f, 0.07f, 0.10f, 0.55f);
        public static Color RadarEnemy = new Color(1.00f, 0.28f, 0.62f, 1f);
        public static Color RadarCross = new Color(1.00f, 0.42f, 0.70f, 0.55f);
        ...
        public static Color Tracer = new Color(1.00f, 0.28f, 0.62f, 0.90f);
        public static Color Crosshair = new Color(1.00f, 0.38f, 0.68f, 0.95f);
        public static Color GlowOuter = new Color(1.00f, 0.28f, 0.62f, 0.22f);
