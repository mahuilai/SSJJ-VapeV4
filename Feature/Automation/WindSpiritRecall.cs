...
namespace Vape.Feature.Automation
{
    public class WindSpiritRecall : MonoBehaviour
    {
        ...
        {
            // Keep path state readable with opacity while sharing one visual hue.
            Color lineColor = hasEnemy
                ? new Color(Vape.UI.Theme.VisualPink.r, Vape.UI.Theme.VisualPink.g, Vape.UI.Theme.VisualPink.b, 0.9f)
                : new Color(Vape.UI.Theme.VisualPink.r, Vape.UI.Theme.VisualPink.g, Vape.UI.Theme.VisualPink.b, 0.58f);
